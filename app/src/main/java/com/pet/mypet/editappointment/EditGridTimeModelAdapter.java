...
public class EditGridTimeModelAdapter extends RecyclerView.Adapter<EditGridTimeModelAdapter.MyViewHolder> {

        private ArrayList<EditTimeModel> timeModelList;
        Context context;
    ...
    public EditGridTimeModelAdapter(ArrayList<EditTimeModel> timeModelList, Context context, ClickAdapter clickAdapter) {

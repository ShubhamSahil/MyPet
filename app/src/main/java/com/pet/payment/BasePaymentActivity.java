...
import com.pet.payment.task.CheckoutIdRequestAsyncTask;
import com.pet.payment.task.CheckoutIdRequestListener;
import com.pet.payment.task.PaymentStatusRequestAsyncTask;
import com.pet.payment.task.PaymentStatusRequestListener;
...
public class BasePaymentActivity extends BaseActivity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("resultpayment", requestCode + " result" + resultCode);

package com.pet.payment.common;
...
//            PAYMENT_BRANDS.add("MADA");
    ...
    public static final String BASE_URL = "https://test.oppwa.com";
    public static final String MERCHANT_ID = "ff80808138516ef4013852936ec200f3";
